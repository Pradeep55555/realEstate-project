        ...
        <div className="explore-wrapper">
            <div className="explore1">
                ...
                <div className="content">
                    <p className='content-paragraph1'>BUY A HOME</p>
                    <span>Find, Buy & Own Your Dream Home</span>
                    <p className='content-paragraph2'>Explore from Apartments, land, builder floors, villas and more</p>
            ...
            <div className="explore2">
                <div className="explore2-left">
                    <div>
                        <span>Top articles on home buying</span>
