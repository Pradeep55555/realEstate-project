...
function BuyerSaveProperty({ open, onClose, properties, buyerMobile }) {
    ...
    const handleSend = (property) => {
        ...
        fetch(`http://localhost:4000/api/buyer/send-message`, {
            method: 'POST',
        ...
        >
            {properties.length === 0 ? (
                <div style={{ padding: 16 }}>
                    <Text type="secondary">No saved properties found.</Text>
                </div>
            ) : (
                <Table
...
export default BuyerSaveProperty;
