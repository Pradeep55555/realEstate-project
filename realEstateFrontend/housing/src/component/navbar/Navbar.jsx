...
//         // console.log("Buyer Mobile : ", mobileFromCookie)
//         if (mobileFromCookie) {
...
//                 setBuyerData(null)
//                 setTimeout(() => {
//                     window.location.reload(); // Refresh after 1 seconds after logout
//                 }, 1000);
//                 // Close profile modal and open login modal
//                 setOpenModal(false);
...
//                         </div>
//                         <div className="headphone"><FaHeadphones /></div>
//                         <div className="profile" onClick={() => setOpenModal(true)}><FaUser /></div>
//                         <div className="buyer-name" onClick={() => setOpenModal(true)}>{buyerData?.full_name ? `Hi, ${buyerData.full_name.split(' ')[0]}` : "Sign in"}</div>
//                     </header>
//                 </div>
//             </div>
